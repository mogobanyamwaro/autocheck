...
function Experience() {
  return (
    <div className="mx-auto max-w-7xl bg-white px-8 pt-10">
      <p className="text-center text-sm text-primary">Why Choose Us</p>
          ...
          <div className="ml-5 flex items-center">
            ...
            <div>
              ...
              <p className="text-xs font-thin text-primary ">
                Dont have a driver? Dont worry we have many experienced drivers
                for you
              </p>
            </div>
          </div>
